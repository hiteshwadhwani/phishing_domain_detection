...
class Data_transformation:
    def __init__(self, data_transformation_config, data_ingestion_artifact):
        logging.info(f"{5 * '<<'} DATA TRANSFORMATION {2 * '>>'}")
    ...
    def intiate_data_transformation(self):
        try:
            ...
            logging.info("Fitting dataset to transformation object")
            ...
            logging.info("Applting oversampling SMOTETomek technique to dataset")
            ...
            logging.info(f"saving train and test data to path {elf.data_transformation_config.train_file_path}")
            ...
            logging.info(f"saving transformatin object to path {self.data_transformation_config.data_transformation_obj_path}")
            ...
            logging.info(f"=================DATA TRANSFORMATION ARTIFACT================== : {data_transfrmation_artifact}")
